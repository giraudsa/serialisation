...
public class ActionJsonString<T> extends ActionJsonSimpleComportement<T> {

	public ActionJsonString(Class<T> type, String nomClef) {
		super(type, nomClef);
	}
	...
	protected void ecritValeur(T obj, TypeRelation relation, Marshaller jsonM, SetQueue<Object> aSerialiser) throws IOException, InstantiationException, IllegalAccessException,
		...
		writeWithQuote((JsonMarshaller)jsonM, StringEscapeUtils.escapeJson(obj.toString()));
	}
