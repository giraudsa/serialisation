...
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryArray;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryCollection;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryDictionary;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryEnum;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryCollection;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryDictionary;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.ActionBinaryObject;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinarySimple;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryAtomicBoolean;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryAtomicInteger;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryAtomicIntegerArray;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryAtomicLong;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryAtomicLongArray;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryBigDecimal;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryBigInteger;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryBitSet;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryCalendar;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryCurrency;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryDate;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryInetAddress;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryLocale;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryStringBuffer;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryStringBuilder;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryUri;
import io.github.giraudsa.fidelis.deserialisation.binary.actions.simple.ActionBinaryUrl;
...
public class BinaryUnmarshaller<T> extends Unmarshaller<T> {
	...
	/*
	 * Lecture d'un champ, appelée par les lecteurs générés (io.github.giraudsa.fidelis.utils.champ.GenerateurSerialiseurs) : un primitif est
