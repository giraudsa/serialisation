...
public class ActionBinaryChar  extends ActionBinarySimpleComportement<Character>{
	...
	public ActionBinaryChar(Class<? super Character> type, Character obj, TypeRelation relation, Boolean isDejaVu, BinaryMarshaller b) throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, NotImplementedSerializeException {
